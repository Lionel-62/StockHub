...
export default function MessagesPage() {
  return (
    <div className="flex h-[calc(100dvh-4rem)] bg-slate-50 dark:bg-[#06101e] items-center justify-center p-4">
      <div className="max-w-md w-full bg-white dark:bg-[#0a192f] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c3a66] p-8 text-center space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Module Messages en préparation</h1>
        ...
        <div className="pt-4 border-t border-slate-100 dark:border-[#152a4d]">
