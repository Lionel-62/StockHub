...
export default function ProductsPage() {
  ...
  const { products, addProduct, updateProduct, deleteProduct, isLoaded: isProductsLoaded } = useProducts();
  const { currentUser, isLoaded: isAuthLoaded } = useAuth();
  const isFullyLoaded = isProductsLoaded && isAuthLoaded;
  ...
  if (isFullyLoaded && products.length === 0 && currentUser?.shopType === "digital") {
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4 animate-in fade-in duration-500">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full max-w-xs sm:max-w-md mx-auto justify-center">
          ...
          <Button variant="outline" className="flex-1 w-full h-11 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-semibold flex items-center justify-center gap-2 bg-transparent hover:bg-slate-50 dark:hover:bg-slate-800">
            En savoir plus
          </Button>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-4 md:col-span-2 pt-4 border-t border-slate-100 dark:border-[#152a4d]">
                  ...
                  <div className="bg-white dark:bg-[#0a192f] border border-slate-200 dark:border-[#1c3a66] rounded-xl p-4">
                    <label className="flex items-center justify-between cursor-pointer">
                      <div className="flex items-start gap-3">
                        <div className="mt-0.5 h-8 w-8 rounded-lg bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 flex items-center justify-center shrink-0">
                          <Sparkles size={16} />
                        </div>
                        <div className="flex flex-col">
                  ...
                  <div className="bg-white dark:bg-[#0a192f] border border-slate-200 dark:border-[#1c3a66] rounded-xl p-4">
                    <label className="flex items-center justify-between cursor-pointer">
                      <div className="flex items-start gap-3">
                        <div className="mt-0.5 h-8 w-8 rounded-lg bg-orange-50 dark:bg-orange-500/10 text-orange-600 dark:text-orange-400 flex items-center justify-center shrink-0">
                          <Package size={16} />
                        </div>
                        <div className="flex flex-col">
                  ...
                  <div className="bg-white dark:bg-[#0a192f] border border-slate-200 dark:border-[#1c3a66] rounded-xl p-4">
                    <label className="flex items-center justify-between cursor-pointer">
                      <div className="flex items-start gap-3">
                        <div className="mt-0.5 h-8 w-8 rounded-lg bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shrink-0">
                          <CheckSquare size={16} />
                        </div>
                        <div className="flex flex-col">
