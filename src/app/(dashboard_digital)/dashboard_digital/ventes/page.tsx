...
import { 
  ...
  Store, AlertCircle, ShoppingBag, PackagePlus, Share, Tag
} from "lucide-react";
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4 animate-in fade-in duration-500">
        <div className="w-16 h-16 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center mb-6">
          <Tag className="text-slate-900" size={28} strokeWidth={2.5} />
        </div>
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Suivez votre première vente</h1>
        <p className="text-slate-500 max-w-lg mb-8 text-sm leading-relaxed">
          Le succès commence par le partage de vos produits avec le monde. Une fois votre première vente réalisée, vous verrez toutes vos transactions et vos revenus ici.
        </p>
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full max-w-xs sm:max-w-md mx-auto justify-center">
          ...
          <Link href={`/b/${currentUser?.id}`} target="_blank" className="flex-1 w-full">
            <Button variant="outline" className="w-full h-11 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-900 font-semibold flex items-center justify-center gap-2 bg-transparent hover:bg-slate-50 dark:hover:bg-slate-800">
              <Share size={18} />
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
              ...
              <Button 
                ...
                className="w-full sm:w-auto bg-[#0b213f] hover:bg-[#18355c] text-white transition-all duration-200 hover:scale-105 active:scale-95 shadow-sm hover:shadow-md flex items-center justify-center"
              >
