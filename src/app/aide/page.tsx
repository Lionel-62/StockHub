  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-sm">
        ...
        <h1 className="text-3xl font-bold text-slate-900 mb-6">Centre d'Aide</h1>
        <div className="prose prose-slate max-w-none">
          <p className="text-lg text-slate-600 mb-8">Comment pouvons-nous vous aider aujourd'hui ?</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="border rounded-lg p-6 flex flex-col items-center text-center hover:border-blue-200 hover:bg-blue-50/50 transition-colors">
              ...
              <p className="text-slate-600 text-sm mb-4">Une réponse rapide par message.</p>
            ...
            <div className="border rounded-lg p-6 flex flex-col items-center text-center hover:border-blue-200 hover:bg-blue-50/50 transition-colors">
              ...
              <p className="text-slate-600 text-sm mb-4">Pour les requêtes détaillées.</p>
