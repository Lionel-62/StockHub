  ...
  return (
    <>
      <header className={`fixed top-4 inset-x-0 z-50 flex justify-center px-4 sm:px-6 transition-transform duration-300 ${isScrolled ? "translate-y-[-0.5rem]" : ""}`}>
        <nav className="w-full max-w-6xl glass-nav border border-slate-200  rounded-full py-2.5 px-4 sm:px-6 flex items-center justify-between shadow-sm transition-all duration-300 hover:border-slate-300 ">
