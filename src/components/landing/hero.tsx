    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden" data-purpose="hero-section">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-3 glass-card border border-slate-200  text-slate-800  p-3.5 rounded-2xl shadow-xl absolute -right-6 top-28 z-30 animate-float-med">
          ...
          <div className="rounded-3xl p-2 sm:p-4 bg-gradient-to-b from-slate-200/70 via-slate-100/50 to-white border border-slate-200  shadow-card-lift relative z-10">
            <div className="rounded-2xl overflow-hidden border border-slate-200  shadow-inner bg-slate-950 flex items-center justify-center">
              <img 
