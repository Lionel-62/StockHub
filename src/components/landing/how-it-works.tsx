...
export function HowItWorks() {
  return (
    <section className="py-20 bg-slate-50 dark:bg-[#06101e]/70 border-t border-slate-200 dark:border-[#1c3a66]/70" data-purpose="how-it-works" id="comment-ca-marche">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <motion.div 
            ...
            whileHover={{ y: -5 }}
            className="bg-white dark:bg-[#0a192f] border border-slate-200 dark:border-[#1c3a66] p-8 rounded-3xl relative shadow-sm hover:shadow-md transition-shadow"
          >
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2 z-10 relative">Créez votre catalogue</h3>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2 z-10 relative">Partagez votre lien</h3>
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed relative z-10">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2 z-10 relative">Encaissez & Synchronisez</h3>
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed relative z-10">
