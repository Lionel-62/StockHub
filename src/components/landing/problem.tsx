...
export function Problem() {
  return (
    <section className="py-20 bg-slate-50 dark:bg-[#06101e]/80 border-y border-slate-200 dark:border-[#1c3a66]/60" data-purpose="problem-section">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <motion.div 
            ...
            whileHover={{ y: -5 }}
            className="bg-white dark:bg-[#0a192f] border border-slate-200 dark:border-[#1c3a66] rounded-2xl p-7 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group"
          >
            ...
            <div className="mt-6 pt-4 border-t border-slate-100 dark:border-[#152a4d] flex items-center text-xs font-semibold text-rose-600 gap-1.5">
          ...
          >
            ...
            <div className="mt-6 pt-4 border-t border-slate-100 dark:border-[#152a4d] flex items-center text-xs font-semibold text-amber-600 gap-1.5">
          ...
          >
            ...
            <div className="mt-6 pt-4 border-t border-slate-100 dark:border-[#152a4d] flex items-center text-xs font-semibold text-[#0b213f] gap-1.5">
