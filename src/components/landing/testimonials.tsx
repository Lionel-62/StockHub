...
export function Testimonials() {
  return (
    <section className="py-24 bg-slate-50 dark:bg-[#06101e]" data-purpose="benefits" id="pourquoi">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-xs uppercase tracking-widest font-bold text-[#0b213f] bg-white dark:bg-[#0a192f] px-3 py-1 rounded-full border border-slate-200 dark:border-[#1c3a66] shadow-sm">
            Vos avantages
          </span>
          <h2 className="text-3xl sm:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div 
            ...
            whileHover={{ y: -5 }}
            className="bg-white dark:bg-[#0a192f] border border-slate-200 dark:border-[#1c3a66] p-8 rounded-3xl shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow"
          >
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Zéro perte de stock</h3>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Vendez sur WhatsApp</h3>
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Sans engagement</h3>
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
